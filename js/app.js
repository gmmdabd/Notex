            ...
            <div class="container">
                <div class="upload-container">
                    ...
                    <form id="upload-form">
                        ...
                        <button type="submit" class="btn btn-block" id="upload-submit-btn"><i class="fas fa-upload"></i> <span class="nav-text">Upload Note</span></button>
                    </form>
                </div>
            </div>
        `;
